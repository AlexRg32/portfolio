...
export const content = {
  es: {
    ...
    about: { eyebrow: 'Perfil', title: 'Diseño con intención. Código sin ruido.', body: 'Me muevo entre diseño y desarrollo para convertir problemas complejos en interfaces sencillas. He trabajado en producto SaaS, e-commerce, herramientas internas y entornos audiovisuales.', meta: 'React · JavaScript · Laravel · Odoo · Shopify' },
    contact: { eyebrow: 'Contacto', title: '¿Hablamos?', body: 'Disponible para colaborar con estudios, negocios y equipos de producto.' },
  },
  en: {
    ...
    about: { eyebrow: 'Profile', title: 'Intentional design. Clean code.', body: 'I work across design and development to turn complex problems into simple interfaces. My experience spans SaaS products, e-commerce, internal tools and broadcast environments.', meta: 'React · JavaScript · Laravel · Odoo · Shopify' },
    contact: { eyebrow: 'Contact', title: 'Let’s talk.', body: 'Available to collaborate with studios, businesses and product teams.' },
  },
};
